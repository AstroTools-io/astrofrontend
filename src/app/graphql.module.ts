...
const uri2 = 'https://subgraph.bscswap.com/subgraphs/name/bscswap/bscswap-subgraph';
const uri3 = 'https://api.thegraph.com/index-node/graphql';
const uri4 = 'https://api.bscgraph.org/subgraphs/id/QmUDNRjYZ7XbgTvfVnXHj6LcTNacDD9GPXHWLjdTKi6om6';
